...
its own "Your sessions" heading, session titles stay on one line cut to a wider
column (State and Installation give up room), a session whose state was not read says "Not
loaded" rather than showing a dash, a search with no match names the term, and
the intro and migration notice no longer mention kagent internals.
