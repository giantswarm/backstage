 ...
 *
 * The ant keeps its brand gradient; the wordmark is `currentColor` so a single
 * asset works on both the Giant Swarm Blue sidebar and light content surfaces.
 * Do not recolor, stretch or add effects to the mark.
 */
