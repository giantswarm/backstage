/**
 * The Giant Swarm ant mark, single-color. Used where the horizontal lockup does
 * not fit — the collapsed sidebar rail and the app icons — and rendered in a
 * single color rather than the brand gradient, which turns to mud below ~32px.
 *
 * `GiantSwarmMarkPaths` is shared with the `giantswarm` entry of the app's icon
 * bundle in `../icons/CustomIcons`.
 */
export const GiantSwarmMarkPaths = () => (
  <>
    <path
      fill="currentColor"
