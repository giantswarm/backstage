  ...
  return (
    <InfoCard title="Installation details">
      <RowList>
        ...
        <Row label="Customer">{ entity.metadata.labels?.['giantswarm.io/customer'] }</Row>
        <Row label="Provider">{ entity.metadata.labels?.['giantswarm.io/provider'] }</Row>
        <Row label="Pipeline">{ entity.metadata.labels?.['giantswarm.io/pipeline'] }</Row>
        <Row label="Region">{ entity.metadata.labels?.['giantswarm.io/region'] ?? <em>not specified</em> }</Row>
        { entity.metadata.annotations?.['giantswarm.io/escalation-matrix'] && (
            <Row label="Escalation matrix"><pre>{entity.metadata.annotations?.['giantswarm.io/escalation-matrix']}</pre></Row>
        )}
