/*
 * This is copy of the OAuthCookieManager.ts file from:
 *
 * https://github.com/backstage/backstage/blob/v1.32.5/plugins/auth-node/src/oauth/OAuthCookieManager.ts
 *
 */
