/*
 * This is copy of the https://github.com/backstage/backstage/blob/v1.32.5/packages/core-app-api/src/apis/implementations/auth/oauth2/OAuth2.ts
 * but it uses CustomAuthConnector instead of the DefaultAuthConnector.
 */
...
import { CustomAuthConnector, PopupOptions } from './lib/AuthConnector';
