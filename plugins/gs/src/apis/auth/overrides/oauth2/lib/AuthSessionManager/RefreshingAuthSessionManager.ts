/*
 * This is copy of the https://github.com/backstage/backstage/blob/v1.32.5/packages/core-app-api/src/lib/AuthSessionManager/RefreshingAuthSessionManager.ts
 */
