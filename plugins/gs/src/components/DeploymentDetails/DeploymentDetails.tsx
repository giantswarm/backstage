...
import { useDeploymentDetailsPane } from '../hooks';
...
export const DeploymentDetails = ({
  ...
  const { isOpen, getDeploymentDetails, close } = useDeploymentDetailsPane();
  const { installationName, kind, namespace, name, gvk } =
