...
import { GS_DEPLOYMENT_NAMES, isEntityDeploymentsAvailable } from './utils/entity';

const GS_PLUGIN_README_URL = 'https://github.com/giantswarm/backstage/tree/main/plugins/gs';
