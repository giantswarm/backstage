...
- When showing information about a component, user, system, group, or other entity, make it a clickable link to the entity page in the Backstage developer portal. Use the `generatePortalUrl` tool to generate the URL.
