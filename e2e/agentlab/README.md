...
| `marge.spec.ts`                | the marge tab lands on a team, offers the team selector, the free team field and the group toggle; a person without a GitHub grant is guided to marge's per-server Sign in, one with a grant sees the queue with Refresh classification and Preview sweep                                                                                                                                                                                                                                                                                                          |
